...
export interface SonataDocument { id: string; path: string; type: DocumentType; title: string; body: string; tags: string[]; created: string; updated: string; archived: boolean; pinned: boolean; status?: TaskStatus; priority?: Priority; stage?: IdeaStage; due?: string; reminder?: string; acknowledgedDue?: string; acknowledgedReminder?: string; parent?: string | null; links?: string[]; bookmark?: { url: string }; cover?: string; contentHash?: string; }
