...
export interface SonataDocument { id: string; path: string; type: DocumentType; title: string; body: string; tags: string[]; created: string; updated: string; archived: boolean; pinned: boolean; status?: TaskStatus; priority?: Priority; due?: string; reminder?: string; parent?: string | null; links?: string[]; bookmark?: { url: string }; contentHash?: string; }
